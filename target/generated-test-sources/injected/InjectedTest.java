...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    System.out.println("Running tests for "+"org.jenkins-ci.plugins:sonar:2.9-SNAPSHOT");
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("basedir","/opt/git-repo");
    parameters.put("artifactId","sonar");
    parameters.put("packaging","hpi");
    parameters.put("outputDirectory","/opt/git-repo/target/classes");
    parameters.put("testOutputDirectory","/opt/git-repo/target/test-classes");
